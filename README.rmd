...
### Summarize results
Display an overview of biological processes and importances per metabolite. Sorts by p-value (ascending) and closeness (descending). A threshold for both the p-value and closeness can be given.
``` {r, message = FALSE}
example_graph() %>%
